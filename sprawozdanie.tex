...
W programie Salome Meca zamodelowano płytę kwadratową o wymiarach 250x250 mm.
Zbadano jej mody oraz wybrano 5, względem których w dalszej części
...
\begin{figure}[!tbh]
  ...
  \caption{Widok na aktuatory zainstalomi BNC, które podłączono do wzmacniacza i
karty pomiarowej. Płyta jest aluminiwane na płycie}
  \label{fig:plate2}
\end{figure}
...
\ref{tab:red1}--\ref{tab:red5}. Wartości amplitud zadanych na aktuatoróy są to
wartości wprowadzane do programu, przed wzmocnieniem, rzeczywiste wartości
napięcia podane na aktuatory były cziesięciokrotnie większe. Na czerwono w
tablicach zaznaczono sytuacje w którcych nie udało się uzyskań napięcia
